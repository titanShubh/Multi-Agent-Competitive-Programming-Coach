    ...
    <div className="min-h-screen bg-dark-950 flex flex-col justify-center items-center px-4 relative overflow-hidden select-none">
      ...
      <div className="max-w-md w-full glass rounded-2xl p-8 space-y-6 z-10 relative">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          <p className="text-xs text-dark-400">Sign up to begin your Socratic mentoring sessions</p>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-dark-900 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-dark-500 outline-none focus:border-brand-500 transition-colors disabled:opacity-50"
                />
                <User className="w-4 h-4 text-dark-500 absolute left-3.5 top-1/2 -translate-y-1/2" />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="name"
                  disabled={authLoading}
                  className="w-full bg-dark-900 border border-white/10 rounded-xl pl-4 pr-4 py-2.5 text-sm text-white placeholder-dark-500 outline-none focus:border-brand-500 transition-colors disabled:opacity-50"
                />
              </div>
            </div>
          </div>
